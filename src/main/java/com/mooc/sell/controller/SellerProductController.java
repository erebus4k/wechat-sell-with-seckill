 ...
 * @version 1.0
 * @author: liupurui
 * @create: 2021−09-03-20:50
 * @className: com.mooc.sell.controller.SellerProductController
 * @description: TODO
 */
@Controller
...
public class SellerProductController {
    ...
    public ModelAndView save(@Valid ProductForm form,      //@Valid 用于验证注解是否符合要求,直接加在变量user之前,在变量中添加验证信息的要求,当不符合要求时就会在方法中返回message 的错误提示信息。
