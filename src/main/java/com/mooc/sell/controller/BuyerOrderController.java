 ...
 * @className: com.mooc.sell.controller.BuyerOrderController
 * @description: TODO
 */
@RestController
...
public class BuyerOrderController {
    ...
    public ResultVO<List<OrderDTO>> list(@RequestParam("openid") String openid,
        ...
        PageRequest request = PageRequest.of(page, size); //别忘了不能用new PageRequest了
    ...
    //取消订单
    @PostMapping("/cancel")
    public <T> ResultVO<T> cancel(@RequestParam("openid") String openid,
                           @RequestParam("orderId") String orderId) {
